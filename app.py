...
# 🎨 CSS ขั้นสูง: ลบคำว่า Upload และข้อความอธิบายทิ้งทั้งหมด บังคับฝังไอคอนมินิมอลขวามือในกล่องเดียวกัน 100%
st.markdown("""
    <style>
...
if not api_key:
    ...
    # 🛠️ เรียกโมเดลรุ่นที่เป็นทางการล่าสุด การันตีพิมพ์ตอบรวดเร็วเสถียรสูงสุด
